...
public class Agenda extends JFrame implements ActionListener{
    ...
    public Agenda() {
     ...
     // Crear un ImageIcon a partir de una imagen en un archivo
        ...
        listaContactos.setForeground(new Color(255, 255, 255));
        listaContactos.setBackground(new Color(55, 55, 55));
        ...
        panelCampos.setBackground(new Color(55, 55, 55));
                
                mostrarDatos = new JButton("Mostrar Datos");
                mostrarDatos.setBackground(new Color(255, 255, 255));
        ...
        botonBorrar.setBackground(new Color(240, 240, 240));
        panelCampos.add(botonBorrar);
        botonBorrar.addActionListener(this);
        botonEditar = new JButton("Editar");
        botonEditar.setBackground(new Color(240, 240, 240));
...
//    		}
        ...
        if (e.getSource() == botonAgregar) {
            ...
            int result = JOptionPane.showConfirmDialog(null, panel, "Agregar contacto", JOptionPane.OK_CANCEL_OPTION);
